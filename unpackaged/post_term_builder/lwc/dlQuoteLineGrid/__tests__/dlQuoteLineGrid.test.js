...
function createComponent() {
    const element = createElement('c-dl-quote-line-grid', { is: DlQuoteLineGrid });
...
describe('c-dl-quote-line-grid', () => {
    ...
    it('toggles the inline attribute picker and wires aria-expanded / aria-controls', async () => {
        ...
        expect(element.shadowRoot.querySelector('c-dl-line-attribute-picker')).toBeNull();

        btn.click();
        await flushPromises();

        const picker = element.shadowRoot.querySelector('c-dl-line-attribute-picker');
    ...
    it('preserves an expanded row across a refresh', async () => {
        ...
        expander(element, 'line1').click();
        await flushPromises();
        expect(element.shadowRoot.querySelector('c-dl-line-attribute-picker')).not.toBeNull();
