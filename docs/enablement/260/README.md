...
This directory contains the Hands-On Exercise catalog for Salesforce Revenue Cloud **Release 260 / Spring '26 / API v66.0** — the current GA release that `rlm-base-dev`'s `main` branch targets.
...
Once 260 is signed off, a render/auto-gen pipeline will lift the structure forward to 262 (`docs/enablement/262/`) with frontmatter swaps and a content delta workflow. See `docs/enablement/_template/exercise-template.md` for the schema the auto-gen reads.
