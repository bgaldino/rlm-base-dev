...
|Ensure you've gone through the setup steps<br><br>Open the Einstein Window, pin it, and select the *Quote Management* agent||![placeholder][img-PLACEHOLDER-agent-pin]|
