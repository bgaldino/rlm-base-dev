...
- **[AbstractTransactionResponse Class](./apex_class_commercetax_AbstractTransactionResponse.htm.md)**  
...
- **[AddressesResponse Class](./apex_class_commercetax_AddressesResponse.htm.md)**  
...
- **[AddressResponse Class](./apex_class_commercetax_AddressResponse.htm.md)**  
  Contains a location code sent from the external tax engine.
- **[AmountDetailsResponse Class](./apex_class_commercetax_AmountDetailsResponse.htm.md)**  
  Sets tax amount fields based on a response from the external tax engine.
- **[CalculateTaxRequest Class](./apex_class_commercetax_CalculateTaxRequest.htm.md)**  
...
- **[CalculateTaxResponse Class](./apex_class_commercetax_CalculateTaxResponse.htm.md)**  
...
- **[CustomTaxAttributesResponse Class](./apex_class_commercetax_CustomTaxAttributesResponse.htm.md)**  
  Sets additional data or custom attributes in the tax response.
- **[ErrorResponse Class](./apex_class_commercetax_ErrorResponse.htm.md)**  
...
- **[HeaderTaxAddressesRequest Class](./apex_class_commercetax_HeaderTaxAddressesRequest.htm.md)**  
  Captures the address values that are applicable for the quote or order transaction.
- **[ImpositionResponse Class](./apex_class_commercetax_ImpositionResponse.htm.md)**  
  Stores details of tax impositions from the external tax engine.
- **[JurisdictionResponse Class](./apex_class_commercetax_JurisdictionResponse.htm.md)**  
...
- **[LineItemResponse Class](./apex_class_commercetax_LineItemResponse.htm.md)**  
  Response class that stores details of a list of one or more line items on which the tax engine has calculated tax.
- **[LineTaxAddressesRequest Class](./apex_class_commercetax_LineTaxAddressesRequest.htm.md)**  
...
- **[RuleDetailsResponse Class](./apex_class_commercetax_RuleDetailsResponse.htm.md)**  
  Contains details about the tax rules used for tax calculation.
- **[TaxAddressesRequest Class](./apex_class_commercetax_TaxAddressesRequest.htm.md)**  
  Contains methods to get and set tax address values.
- **[TaxAddressRequest Class](./apex_class_commercetax_TaxAddressRequest.htm.md)**  
  Contains address details used for tax calculation.
- **[TaxApiException Class](./apex_class_commercetax_TaxApiException.htm.md)**  
  Contains details about any exceptions during the tax calculation process. Extends the `ApexBaseException` class.
- **[TaxCustomerDetailsRequest Class](./apex_class_commercetax_TaxCustomerDetailsRequest.htm.md)**  
  Contains customer details used in tax calculation.
- **[TaxDetailsResponse Class](./apex_class_commercetax_TaxDetailsResponse.htm.md)**  
  Stores details of the tax values that an external tax engine calculates in response to a tax calculation request.
- **[TaxEngineAdapter Interface](./apex_interface_commercetax_TaxEngineAdapter.htm.md)**  
  Retrieves information from the tax engine and evaluates the information to define tax details.
- **[TaxEngineContext Class](./apex_class_commercetax_TaxEngineContext.htm.md)**  
  Wrapper class that stores details about the type of a tax calculation request.
- **[TaxLineItemRequest Class](./apex_class_commercetax_TaxLineItemRequest.htm.md)**  
  Contains line item details of a tax request.
- **[TaxSellerDetailsRequest Class](./apex_class_commercetax_TaxSellerDetailsRequest.htm.md)**  
  Contains tax code details used in the tax calculation request.
- **[TaxTransactionRequest Class](./apex_class_commercetax_TaxTransactionRequest.htm.md)**  
