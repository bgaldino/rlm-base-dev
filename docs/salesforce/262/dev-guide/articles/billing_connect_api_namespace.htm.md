...
- **[BatchInvoiceApplication Class](./apex_ConnectAPI_BatchInvoiceApplication_static_methods.htm.md)**  
...
- **[Billing Class](./apex_ConnectAPI_Billing_static_methods.htm.md)**  
...
- **[CreditMemoApply Class](./apex_ConnectAPI_CreditMemoApply_static_methods.htm.md)**  
  Manage credit memo applications by using the CreditMemoApply class.
- **[CreditMemoLineApply Class](./apex_ConnectAPI_CreditMemoLineApply_static_methods.htm.md)**  
  Manage credit memo line applications by using the CreditMemoLineApply class.
- **[HarmonizeBilling Class](./apex_ConnectAPI_HarmonizeBilling_static_methods.htm.md)**  
  Update the status of the invoice from Draft to Posted by using the HarmonizeBilling class.
- **[PaymentsBilling Class](./apex_ConnectAPI_PaymentsBilling_static_methods.htm.md)**  
...
- **[SequencingWithoutAura Class](./apex_ConnectAPI_SequencingWithoutAura_static_methods.htm.md)**  
