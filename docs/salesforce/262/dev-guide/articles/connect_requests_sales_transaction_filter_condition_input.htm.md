...
:   | Name | Type | Description | Required or Optional | Available Version |
    ...
    | `operands` | [Sales Transaction Operand](./connect_requests_sales_transaction_operand_input.htm.md)[] | Operand values with explicit value and type metadata. | Required | 67.0 |
