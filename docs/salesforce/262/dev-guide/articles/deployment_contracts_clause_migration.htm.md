...
Migration](./deployment_contracts_clause_validation_migration_constraints.htm.md).
...
- Clauses are inserted in Draft status. Run a subsequent migration to update the clause
  status. See [Clause Status Mapping During
  Migration](./deployment_contracts_clause_validation_migration_constraints.htm.md) for details on how clause statuses are applied and updated.
