...
| [`help/`](help/) | Per-article Salesforce Help portal snapshot for 262 (932 articles across 11 RC areas; captured 2026-05-11 / 2026-05-12, collections 2026-06-21, via `tasks/rlm_snapshot_help.py`). Replaces the older PDF compendium as the grep-friendly, diffable AI grounding source. See the `revenue-cloud-docs` skill. |
...
> **Partial substitute available now:** the per-article Help snapshot at `docs/salesforce/262/help/articles/` (932 articles, captured 2026-05-11 / 2026-05-12 — see `.cursor/skills/revenue-cloud-docs/SKILL.md`) covers most of what the compendium PDF will eventually consolidate. Where a `(TBD)` row in this index has an obvious matching Help article, agents grounding new content should cite the snapshot article rather than waiting for the PDF.
