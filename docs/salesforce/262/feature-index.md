# Release 262 (Summer '26) — Feature Index (Preview)

Per-area inventory of features in Summer '26 / Release 262, extracted from the available preview sources. **Status: Preview.** The full master Help compendium for 262 will be available approximately mid-May 2026 (5 days after 2026-05-07). Until then this index is built from the internal Solution Overview decks plus the public preview release notes.
...
| File | Description |
|---|---|
| `solution-overview-summer-26-rca.pdf` | Internal Solution Overview deck — Revenue Cloud Advanced (97 pp, CONFIDENTIAL) |
| `solution-overview-summer-26-billing.pdf` | Internal Solution Overview deck — Revenue Cloud Billing (48 pp, CONFIDENTIAL) |
| `salesforce-release-notes-summer-26-2026-05-07.pdf` | Full Salesforce Release Notes (996 pp, public — preview status). Revenue Management section starts at p 720. |
| (TBD) | Master Help compendium for 262 — expected ~mid-May 2026 |
