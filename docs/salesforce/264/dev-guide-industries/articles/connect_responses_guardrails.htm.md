...
|  | [Guardrail Current Value](./connect_responses_guardrail_current_value.htm.md) | Resource type and the row-level current values of the guardrail. For future use only. | Small, 63.0 | 63.0 |
