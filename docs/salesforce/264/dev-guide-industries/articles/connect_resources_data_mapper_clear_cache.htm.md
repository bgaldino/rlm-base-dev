...
| `dataMapperList` | [Data Mapper Details](./connect_requests_data_mapper_details.htm.md)[] | List of data mappers to clear the cache for. | Required | 64.0 |
...
: [Data Mapper Cache
              Details](./connect_responses_datamapper_clear_cache_output.htm.md)
