...
| `assessmentReasons` | [List<AssessmentReasonInputRepresentation>](./connect_requests_assessment_responses_assessment_reason_input.htm.md) | Details of the assessment. | Optional | 63.0 |
