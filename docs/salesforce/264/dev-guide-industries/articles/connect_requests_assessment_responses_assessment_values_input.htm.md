...
| `assessmentDetails` | [AssessmentDetailsInputRepresentation](./connect_requests_assessment_responses_assessment_details_input.htm.md) | Metadata of the Assessment Questions. | Optional | 63.0 |
