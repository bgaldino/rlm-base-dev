...
| `error` | [Pricing Error Response](./connect_responses_pricing_error_response.htm.md) | Displays the error encountered when the request is processed. For example, a pricing procedure isn’t found. | Small, 60.0 | 60.0 |
