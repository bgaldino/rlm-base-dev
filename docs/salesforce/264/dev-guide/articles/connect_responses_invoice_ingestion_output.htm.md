...
| --- | --- | --- | --- | --- |
| `errors` | [Invoice Ingestion Output Error](./connect_responses_invoice_ingestion_output_error.htm.md)[] | Details of the errors if the request was unsuccessful. | Small, 63.0 | 63.0 |
