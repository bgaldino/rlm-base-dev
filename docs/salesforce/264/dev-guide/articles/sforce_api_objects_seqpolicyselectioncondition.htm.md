...
```
https://yourInstance.salesforce.com/services/data/v68.0/sobjects/SeqPolicySelectionCondition
```
...
```
https://yourInstance.salesforce.com/services/data/v68.0/sobjects/SeqPolicySelectionCondition/id
```
