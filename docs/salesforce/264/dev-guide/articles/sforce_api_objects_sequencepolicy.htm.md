...
```
https://yourInstance.salesforce.com/services/data/v68.0/sobjects/SequencePolicy
```
...
```
https://yourInstance.salesforce.com/services/data/v68.0/sobjects/SequencePolicy/id
```
