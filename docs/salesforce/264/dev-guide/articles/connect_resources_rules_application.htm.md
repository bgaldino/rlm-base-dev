...
```
https://yourInstance.salesforce.com/services/data/v68.0/revenue/billing/transactions/actions/apply
```
...
: [Rules
              Application](./connect_responses_rules_application_output.htm.md)
