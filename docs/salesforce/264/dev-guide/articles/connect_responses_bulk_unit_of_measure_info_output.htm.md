...
| `uomIdToUnit​OfMeasure​Info` | Map<String, [Unit Of Measure Info](./connect_responses_unit_of_measure_info_output.htm.md)> | Unit of measure record IDs mapped to their details. | Small, 63.0 | 63.0 |
