...
| `apiExecution​LogRepresentation​List` | [API Execution Log Response](./connect_responses_api_execution_log.htm.md)[] | List of API execution logs. | Small, 63.0 | 63.0 |
| `currencyCode` | String | Currency code that’s stored in each API log record for the pricing execution. | Small, 67.0 | Small, 67.0 |
| `error` | [Pricing Error Response](./connect_responses_pricing_error_response.htm.md) | Error details of the pricing execution process. | Small, 63.0 | Small, 63.0 |
