...
| `referenceLine​Error​Results` | [Reference Line Error](./connect_responses_reference_line_error.htm.md)[] | List of errors grouped by the invoice line IDs if the API request fails. | Big, 62.0 | 62.0 |
