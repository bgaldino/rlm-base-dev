...
| `errors` | [Ramp Deal Service Error Response](./connect_responses_ramp_deal_service_error_response.htm.md)[] | List of errors encountered during the processing of the API request. | Small, 62.0 | 62.0 |
