...
| `values` | [Facet Value](./connect_responses_facet_value.htm.md)[] | Values of the facet found in the search result. Sorted by display name in alphabetical order. | Medium, 63.0 | 63.0 |
