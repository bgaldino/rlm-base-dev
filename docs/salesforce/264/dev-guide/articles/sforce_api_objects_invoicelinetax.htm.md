...
| NetCreditsApplied | **Type** currency **Properties** Filter, Nillable, Sort **Description** The total credit memo line amount that’s applied to the invoice line tax. This amount is calculated by subtracting the unapplied credit memo line amount from the applied credit memo line amount. This field is available in API version 68.0 and later. This field is a calculated field. |
| NetPaymentsApplied | **Type** currency **Properties** Filter, Nillable, Sort **Description** The total payment amount that’s applied to the invoice line tax. This amount is calculated by subtracting the unapplied payment line invoice line amount from the applied payment line invoice line amount. This field is available in API version 68.0 and later. This field is a calculated field. |
...
**[InvoiceLineTaxFeed](./sforce_api_associated_objects_feed.htm.md)**
...
**[InvoiceLineTaxHistory](./sforce_api_associated_objects_history.htm.md)**
