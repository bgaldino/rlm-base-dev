...
```
https://yourInstance.salesforce.com/services/data/v68.0/commerce/billing/credit-memos/50gVB0000003khRYAQ/actions/void
```
...
: [Void Posted Credit
              Memo](./connect_responses_void_posted_credit_memo_output.htm.md)
