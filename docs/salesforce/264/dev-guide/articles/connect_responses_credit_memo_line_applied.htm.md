...
| --- | --- | --- | --- | --- |
| `applied​CreditResponses` | [Credit Memo Line Applied Response](./connect_responses_credit_memo_line_applied_response.htm.md)[] | Output list for the applied credit memo line results. | Big, 62.0 | 62.0 |
