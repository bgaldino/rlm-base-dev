...
| `product​Selling​Model` | [Product Selling Model](./connect_responses_product_selling_model_output.htm.md) | Master-detail field to the product selling model. | Small, 60.0 | 60.0 |
