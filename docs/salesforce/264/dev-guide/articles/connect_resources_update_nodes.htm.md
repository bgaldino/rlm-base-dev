...
```
https://yourInstance.salesforce.com/services/data/v68.0/connect/cpq/configurator/actions/update-nodes
```
...
: [Configurator Update
              Nodes](./connect_responses_update_nodes_configurator_output.htm.md)
