...
| `errors` | [Clone Sales Transaction Error Response](./connect_responses_clone_sales_transaction_error_response.htm.md)[] | List of errors encountered during synchronous processing. | 64.0 |
