...
| Output | Details |
| --- | --- |
| resultCatalogList | **Type** Apex-defined **Description** List of filtered catalog records. See [CatalogOutputRepresentation](./apex_class_runtime_industries_cpq_CatalogOutputRepresentation.htm.md). |
