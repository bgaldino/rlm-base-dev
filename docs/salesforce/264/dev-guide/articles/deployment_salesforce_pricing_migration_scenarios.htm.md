...
To migrate pricing procedures, see [Export and Import Procedure
        Plans](https://help.salesforce.com/s/articleView?id=ind.pricing_export_and_import_procedure_plans.htm&language=en_US).

    

To import and export pricing data, see [Considerations for Importing and
        Exporting Pricing Data](https://help.salesforce.com/s/articleView?id=ind.pricing_considerations_for_importing_and_exporting_pricing_data.htm&language=en_US). Keep these considerations in mind for first-time
      migration.
