...
```
https://yourInstance.salesforce.com/services/data/v68.0/revenue/billing/accounts/accountId/statement
```
...
: [Account Statement
              Response](./connect_responses_statement_of_account_output.htm.md)
