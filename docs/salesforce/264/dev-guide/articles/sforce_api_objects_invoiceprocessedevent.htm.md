...
| InvoiceErrorDetailEvent | **Type** [InvoiceErrorDetailEvent[]](./sforce_api_objects_invoiceerrordetailevent.htm.md) **Properties** Nillable **Description** Information about errors that occurred during processing. |
| InvoiceProcessedDetailEvents | **Type** [InvoiceProcessedDetailEvent[]](./sforce_api_objects_invoiceprocesseddetailevent.htm.md) **Properties** Nillable **Description** A list of `InvoiceProcessedDetailEvent` records. Each record contains information about an attempt to create an invoice from one or more billing schedules that share a grouping key. |
