---
page_id: pricing_overview.htm
title: Salesforce Pricing
source_url: https://developer.salesforce.com/docs/atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/pricing_overview.htm
release: 264
...
- 
**[Salesforce Pricing Standard Objects](./pricing_std_objects_parent.htm.md)**  
...
- 
**[Salesforce Pricing Fields on Standard Objects](./pricing_salesforce_pricing_fields_on_standard_objects.htm.md)**  
...
- 
**[Salesforce Pricing Business APIs](./pricing_business_apis.htm.md)**  
...
- 
**[Salesforce Pricing Apex Reference](./pricing_apex_reference.htm.md)**  

Use built-in Apex classes and interfaces grouped by     namespace.

- 
**[Salesforce Pricing Standard Invocable Actions](./pricing_invocable_actions_parent.htm.md)**  

Learn more about the standard invocable actions available with Salesforce     Pricing.

- 
**[Salesforce Pricing Metadata API Types](./pricing_metadata_api_parent.htm.md)**  

Metadata API enables you to access some types and feature settings that you can     customize in the user interface.

- 
**[Salesforce Pricing Tooling API Objects](./pricing_tooling_api_parent.htm.md)**  
...
- [*Salesforce Help*: Permissions for Salesforce Pricing](https://help.salesforce.com/s/articleView?id=ind.pricing_permissions_salesforce_pricing.htm&type=5&language=en_US)
