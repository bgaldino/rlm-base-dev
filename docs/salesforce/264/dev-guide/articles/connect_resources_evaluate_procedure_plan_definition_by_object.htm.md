...
```
https://yourInstance.salesforce.com​/services/data​/v68.0/connect/​procedure-plan-definitions/​evaluate
```
...
: [Procedure Plan
              Evaluation Response](./connect_responses_procedure_plan_evaluation_response.htm.md)
