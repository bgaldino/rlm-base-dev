...
| `response​Error` | [Place Quote Error Response](./connect_responses_place_quote_error_response.htm.md) [] | List of errors encountered during the synchronous processing. | Small, 60.0 | 60.0 |
