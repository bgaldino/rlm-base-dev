...
```
https://yourInstance.salesforce.com/services/data/v68.0/commerce/invoicing/billing-schedules/collection/actions/recover
```
...
: [Billing Schedule
              Recovery List](./connect_responses_billing_schedule_recovery_list_output.htm.md)
