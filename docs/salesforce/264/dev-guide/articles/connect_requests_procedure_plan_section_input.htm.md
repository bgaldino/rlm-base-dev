...
| `procedurePlan​Options` | [Procedure Plan Option Input](./connect_requests_procedure_plan_option_input.htm.md)[] | List of procedure plan options that defines a group of criteria. You can edit or delete a procedure plan option only if it isn’t associated with an active procedure plan version. | Required | 62.0 |
