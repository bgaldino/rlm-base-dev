...
| --- | --- | --- | --- | --- |
| `error` | [Sequence Gap Reconciliation Error](./connect_responses_sequence_gap_reconciliation_error_output.htm.md)[] | List of errors encountered during the processing of the API request. | Big, 65.0 | 65.0 |
