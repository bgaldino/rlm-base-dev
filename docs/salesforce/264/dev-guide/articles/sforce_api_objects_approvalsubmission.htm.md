...
**[ApprovalSubmissionOwnerSharingRule](./sforce_api_associated_objects_ownersharingrule.htm.md)**
...
**[ApprovalSubmissionShare](./sforce_api_associated_objects_share.htm.md)**
