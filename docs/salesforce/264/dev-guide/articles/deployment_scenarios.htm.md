...
| --- | --- | --- |
| Large Catalog Refresh Introduce 200+ new SKUs for accessories line | Metadata: [See Additional Deployment Information](./deployment_appendix_C.htm.md). Data: bulk product load, product classes, selling models, price book entries, discount schedules, association to categories, catalogs | In the target org: Align baseline metadata. Validation: Run automated regression tests on bundles and pricing. Validate sample SKUs across categories. |
