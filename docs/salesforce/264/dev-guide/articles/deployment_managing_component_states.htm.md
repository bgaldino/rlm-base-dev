...
Some Revenue Management components have unique activation requirements. For
        complete information about state management for these components, see [Additional Deployment Information](./deployment_appendix_C.htm.md).
