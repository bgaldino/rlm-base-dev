...
See also [Arithmetic Calculations and Functions](./cml_core_concept_examples.htm.md) and examples [here](./cml_business-centric_cml_guidelines_quantity_and_aggregation_fun.htm.md).
