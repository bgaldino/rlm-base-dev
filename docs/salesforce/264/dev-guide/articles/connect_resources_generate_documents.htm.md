...
```
https://yourInstance.salesforce.com/services/data/v68.0/revenue/billing/document/actions/generate
```
...
: [On-Demand Document
              Generation Response](./connect_responses_on_demand_doc_gen_output.htm.md)
