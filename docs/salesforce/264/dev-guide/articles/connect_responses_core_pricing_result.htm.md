...
| `errors` | [Pricing Error Response[]](./connect_responses_pricing_error_response.htm.md) | Displays processing errors related to the element as recognized by the data path. | Small, 60.0 | 60.0 |
