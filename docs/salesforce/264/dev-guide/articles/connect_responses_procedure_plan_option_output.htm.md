...
| `procedure​PlanCriterion` | [Procedure Plan Criterion](./connect_responses_procedure_plan_criterion_output.htm.md)[] | Details of the rule-based criteria for the procedure. | Small, 62.0 | 62.0 |
