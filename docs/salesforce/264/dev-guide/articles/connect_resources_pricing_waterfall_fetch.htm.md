...
If price waterfall persistence is disabled from Salesforce Pricing Setup in your org, this
        API doesn't return the waterfall details. You can view the waterfall details in the [Pricing API](./connect_resources_headless.htm.md) or [Price Context API](./connect_resources_price_context.htm.md) response if
...
You can set up advanced price logs to capture
      ...
      Logs](https://help.salesforce.com/s/articleView?id=ind.pricing_advanced_price_log_settings.htm&language=en_US).
...
: [Line Item Waterfall
            Response](./connect_responses_line_item_waterfall_response.htm.md)
