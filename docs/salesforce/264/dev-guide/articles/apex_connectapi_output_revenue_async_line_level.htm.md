...
| `referenceLineErrorResults` | List<[ConnectApi.ReferenceLineError](./apex_connectapi_output_reference_line_error.htm.md)> | List of errors grouped by the invoice line IDs if the API request fails. | 62.0 |
