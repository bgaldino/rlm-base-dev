...
| `procedurePlan​Definition​Versions` | [Procedure Plan Definition Version](./connect_responses_procedure_plan_definition_version_output.htm.md)[] | Details of the versions of a procedure plan definition. | Small, 62.0 | 62.0 |
