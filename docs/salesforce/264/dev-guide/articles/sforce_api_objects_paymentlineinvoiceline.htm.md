...
| InvoiceLineTaxId | **Type** reference **Properties** Filter, Group, Nillable, Sort **Description** The invoice line tax record to which the payment line was applied or unapplied. This field is available in API version 68.0 and later. This field is a relationship field. **Relationship Name** InvoiceLineTax **Refers To** InvoiceLineTax |
...
| SettlementType | **Type** picklist **Properties** Filter, Group, Nillable, Restricted picklist, Sort **Description** Specifies the type of amount settled by the payment line that’s applied to the invoice line. This field is available in API version 68.0 and later. Valid values are: `Balance` `Charge` `Tax` |
