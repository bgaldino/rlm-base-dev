...
For complete information on the required deployment sequence, see [Object Deployment Sequence](./deployment_appendix_A.htm.md) and [Metadata Deployment Reference](./deployment_appendix_B.htm.md).
