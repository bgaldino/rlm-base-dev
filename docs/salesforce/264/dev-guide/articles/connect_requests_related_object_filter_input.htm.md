...
| --- | --- | --- | --- | --- |
| `criteria` | [Filter Criteria Input](./connect_requests_filter_criteria_input.htm.md)[] | Criteria to filter the related objects. | Required if the relatedObjectFilters property is specified. | 60.0 |
