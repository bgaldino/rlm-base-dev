...
| `procedure​PlanSections` | [Procedure Plan Section](./connect_responses_procedure_plan_section_output.htm.md)[] | List of sections of the procedure plan definition that you can organize in any order. Each section must include a procedure or a set of procedures to be executed for a specific criteria. | Small, 62.0 | 62.0 |
