...
```
https://yourInstance.salesforce.com/services/data/v68.0/sobjects/PricebookEntry
```
...
**[PriceBookEntryChangeEvent](./sforce_api_associated_objects_change_event.htm.md)**
...
**[PriceBookEntryHistory](./sforce_api_associated_objects_history.htm.md)**
