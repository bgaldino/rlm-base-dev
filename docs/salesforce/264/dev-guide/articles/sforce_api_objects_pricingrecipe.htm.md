...
| IsInternal | **Type** boolean **Properties** Defaulted on create, Filter, Group, Sort **Description** Indicates if the price recipe record is created internally by the platform (true) or not (false). The default value is `false`. |
