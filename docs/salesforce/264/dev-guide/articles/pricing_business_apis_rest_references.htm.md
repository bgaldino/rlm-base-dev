---
page_id: pricing_business_apis_rest_references.htm
title: Resources
source_url: https://developer.salesforce.com/docs/atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/pricing_business_apis_rest_references.htm
release: 264
...
- 
**[PBE Derived Pricing (POST)](./connect_resources_pbe_source_pricing_derived_product.htm.md)**  

Get the source product for the Price Book Entry (PBE) derived       pricing.

- 
**[Price Context (POST)](./connect_resources_price_context.htm.md)**  

Perform a pricing request by using the instance ID of a       context.

- 
**[Pricing (POST)](./connect_resources_headless.htm.md)**  
...
- 
**[Pricing Waterfall (POST)](./connect_resources_pricing_waterfall_post.htm.md)**  

Create a log of price waterfall. Price waterfall provides insights       into every step of the pricing process.

- 
**[Procedure Plan Definitions (GET, POST)](./connect_resources_get_procedure_plan_definition_records.htm.md)**  

Get the records of procedure plan definitions. Additionally, create a       record of a procedure plan definition.

- 
**[Procedure Plan Definition By ID (GET, PATCH, DELETE)](./connect_resources_get_procedure_plan_definition_by_ID.htm.md)**  

Get, update, or delete a procedure plan definition record by using the       record ID.

- 
**[Procedure Plan Evaluation By Object (POST)](./connect_resources_evaluate_procedure_plan_definition_by_object.htm.md)**  
...
- 
**[Procedure Plan Evaluation By Definition Name (POST)](./connect_resources_evaluate_procedure_plan_by_definition_name.htm.md)**  
...
- 
**[Procedure Plan Version (POST)](./connect_resources_create_procedure_plan_version_record.htm.md)**  

Create records of a procedure plan version with     details.

- 
**[Procedure Plan Version Details (GET, PATCH, DELETE)](./connect_resources_get_procedure_plan_version_details.htm.md)**  

Get, update, or delete a procedure plan definition version record by       using the record ID.

- 
**[Pricing Simulation Input Variables With Data (GET)](./connect_resources_get_pricing_simulation_data_with_variables.htm.md)**  
