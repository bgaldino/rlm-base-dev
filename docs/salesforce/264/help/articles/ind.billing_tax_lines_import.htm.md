...
source_url: https://help.salesforce.com/s/articleView?id=ind.billing_tax_lines_import.htm&type=5&release=264
release: 264
...
See Create Tax Policies and Treatments and Generate Invoices in Revenue Management.
