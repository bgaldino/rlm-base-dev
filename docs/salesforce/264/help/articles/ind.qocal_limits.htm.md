...
source_url: https://help.salesforce.com/s/articleView?id=ind.qocal_limits.htm&type=5&release=264
release: 264
...
OBJECT	LIMIT
Quote Line Items	Up to 2,000 per quote
Order Products	Up to 2,000 per order
