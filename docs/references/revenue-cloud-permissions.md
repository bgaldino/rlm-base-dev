...
| `RLM_QuotingAgent` | `agents` | `prepare_agents` step 6 | Agent access to `RLM_Revenue_Quote_Management` |
...
| 21.6 | `prepare_agents` | `RLM_QuotingAgent`, `RLM_BillingEmployeeAgent` | `agents` |
