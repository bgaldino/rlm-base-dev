...
| `prepare_tso` | Trialforce Source Org (TSO)-specific PSL/PSG/permissions/metadata | `tso` |
...
│   ├── post_tso/               # Trialforce Source Org (TSO)-specific metadata
