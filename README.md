...
| `configure_revenue_settings` | `rlm_configure_revenue_settings.py` | Configure Revenue Settings: Pricing Procedure, Usage Rating, Instant Pricing toggle, Create Orders Flow, Create Contracts Flow, and Manage Assets Flow (Robot Framework) | See `cumulusci.yml` |
