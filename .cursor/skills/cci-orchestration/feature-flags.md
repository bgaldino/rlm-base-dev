...
**41 feature flags**, **86 configuration values**, **37 YAML anchors** under `project.custom`.
...
| `quantumbit_partner_discount_dataset` | `datasets/sfdmu/qb/en-US/qb-partner-discount` |
