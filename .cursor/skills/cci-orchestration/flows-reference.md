...
2. **task** `deploy_mfg_core`  `when: project_config.project__custom__badger`
3. **task** `deploy_mfg_tso_perms`  `when: project_config.project__custom__badger and project_config.project__custom__tso`
