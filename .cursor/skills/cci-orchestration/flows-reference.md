...
Shared AI enablement block for agents and MCP. Each child flow gates its task steps with the corresponding feature flag.

**Steps:**

1. **flow** `prepare_agents`
2. **flow** `prepare_mcp`
