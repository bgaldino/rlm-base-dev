...
2. **Per-release extracts** (`docs/enablement/{version}/`) — **filtered views** of the master set, scoped to net-new and enhanced features for a specific release (e.g., 260, 262). Used when the audience already knows prior-cycle content and only wants the delta. Generated by the render task from the master frontmatter — not authored independently.
...
4. **Generate 260 and forward.** 260 is current GA. 262 is in preview / WIP.
...
|---|---|---|
| 260 (Spring '26) | GA — current | [`docs/salesforce/260/feature-index.md`](../../../docs/salesforce/260/feature-index.md) |
| 262 (Summer '26) | Preview / WIP | (TBD — generated when `262-test` promotes to `main`) |
