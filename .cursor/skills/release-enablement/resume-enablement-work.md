...
Expected branch: typically `feat/enablement-260-master-exercises` (or a descendant). If on `main`, check whether the user wants to switch — enablement work happens on a feature branch.
