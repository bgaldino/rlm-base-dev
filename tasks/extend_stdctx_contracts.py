...
class ExtendStandardContextContracts(SFDXBaseTask):
    """
    A class that extends the functionality of the Standard Contracts Context in a Salesforce org.
    ...
    def _extend_context_definition(self):
        ...
        payload = {
            ...
            "description": "Extension of Contracts Context",
    ...
    def _process_version_list(self, version_list):
        ...
        for mapping in context_mappings:
            if mapping.get("name") == "OppToCntrPersistenceMapping":
                self.context_mapping_id = mapping['contextMappingId']
                self.logger.info(f"Contracts Context Mapping ID: {self.context_mapping_id}")
    ...
    def _update_context_mappings(self):
        ...
        payload = {
            "contextMappings": [{"contextMappingId": self.context_mapping_id, "isDefault": "true", "name": "OppToCntrPersistenceMapping"}]
        }
