...
class ExtendStandardContextCart(SFDXBaseTask):
    """
    ...
    def _extend_context_definition(self):
        ...
        payload = {
            "name": "RLM_CartContext",
            "description": "Extension of Standard Cart Context",
            "developerName": "RLM_CartContext",
            "baseReference": "CartContext__stdctx",
    ...
    def _process_version_list(self, version_list):
        ...
        for mapping in context_mappings:
            if mapping.get("name") == "CartOperation":
                self.context_mapping_id = mapping['contextMappingId']
                self.logger.info(f"Cart Context Mapping ID: {self.context_mapping_id}")
    ...
    def _update_context_mappings(self):
        ...
        payload = {
            "contextMappings": [{"contextMappingId": self.context_mapping_id, "isDefault": "true", "name": "CartOperation"}]
        }
