...
> the body, response shape, and sequencing, *not* to the version in the path. Any
> version appearing inside a captured *response* is what the server returned and is
> left as recorded. Re-verification on a fresh 264 org is tracked in
